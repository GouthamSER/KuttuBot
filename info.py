...
TMDB_API_KEY = environ.get('TMDB_API_KEY', '')  # optional: TMDB fallback when IMDb returns nothing
...
LOG_STR += (f"TMDB_API_KEY set — TMDB fallback enabled for failed IMDb searches.\n" if TMDB_API_KEY else "TMDB_API_KEY not set — IMDb-only mode (no TMDB fallback).\n")
