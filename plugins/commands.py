...
from info import CHANNELS, ADMINS, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT,FILE_CHANNEL_SENDING_MODE, FILE_AUTO_DELETE_SECONDSFILE_CHANNELS
